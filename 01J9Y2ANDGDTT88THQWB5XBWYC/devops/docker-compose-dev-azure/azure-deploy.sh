...
resourcename="otto-cs"  # lower case, only
resourcegroup="otto-cs_rg"
...
# git clone https://github.com/apilogicserver/otto-cs.git
# cd otto-cs
...
az group create --name otto-cs_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group otto-cs_rg --sku S1 --is-linux
az container create --resource-group otto-cs_rg --name otto-cs --image apilogicserver/otto-cs:latest --dns-name-label otto-cs --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//otto-cs.westus.azurecontainer.io:5656'

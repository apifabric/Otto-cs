...
@Component({
  selector: 'ContactLog-home',
  templateUrl: './ContactLog-home.component.html',
  styleUrls: ['./ContactLog-home.component.scss']
})
export class ContactLogHomeComponent implements AfterViewInit {
